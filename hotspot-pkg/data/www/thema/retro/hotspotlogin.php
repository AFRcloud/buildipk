...
// Case 1: SUCCESS - Login successful
if ($result == 1) {
    include('template/'.$template.'/login-successful.php');
    include('template/'.$template.'/loginform-footer.php');
}

// Case 2: FAILED - Login failed
if ($result == 2) {
    // Tampilkan notifikasi error terlebih dahulu
    include('template/'.$template.'/login-failed-notification.php');
}

// Case 2 & 5: Tampilkan form login (failed atau belum login)
