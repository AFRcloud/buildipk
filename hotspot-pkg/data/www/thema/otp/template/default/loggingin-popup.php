...
// Asumsi variabel $h1Loggingin dan $centerPleasewait sudah didefinisikan di tempat lain
// atau Anda bisa mendefinisikannya di sini jika ini adalah file mandiri
$h1Loggingin = isset($h1Loggingin) ? $h1Loggingin : "Sedang Login...";
$centerPleasewait = isset($centerPleasewait) ? $centerPleasewait : "Mohon tunggu sebentar.";
...
<head>
  ...
  <style>
      ...
      * {
      ...
      /* Specific styles for loggingin-popup.php */
      .main-content {
          flex-grow: 1;
          display: flex;
          flex-direction: column;
      ...
      .main-content .logging-title {
          font-size: 24px;
          font-weight: 600;
          color: var(--text-color);
          margin-bottom: 8px;
      }
      .main-content .wait-message {
          font-size: 16px;
          color: var(--tab-button-color);
      }
  </style>
...
<body>
  <div class="container">
      ...
      <div class="main-content">
          ...
          <h1 class="logging-title"><?php echo htmlspecialchars($h1Loggingin); ?></h1>
          <p class="wait-message"><?php echo htmlspecialchars($centerPleasewait); ?></p>
      </div>
  </div>
